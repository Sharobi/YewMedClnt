...
<section class="wrapper">
	<div class="row">
		<div class="col-lg-12">
			<p><spring:message code="rptpurchasesummary.jsp.title" text="Doctors wise sale summary..." /></p>
				...
				<div class="panel-body">
					...
					<table>
						<tr align="center" style="font-weight: bold;">
								...
								<td width="40%" id="doctor_label"><spring:message code="dctr.jsp.name" text="Doctor's Name" /></td>
								<td></td>
							</tr>
						<tr>
...
// });
var pdf_url_sale_rpt_doctor_wise_sale_summary='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_REP_POS_DOCTORS_WISE_SALE_REPORT)%>';
	...
	/* function getCurrPurchase(){
		...
		else
		{
			...
			var pdfline="<iframe src='"+pdf_url_purchase_reg+"?cmpnyId="+compid+"&storeId="+storeid+"&rptType="+rpttype+"&finYrId="+finyrid+"&distributorId="+distid+"&startDate="+strtdate+"&endDate="+enddate+"' style='width:100%; height:450px;' frameborder='0'></iframe>";
	 ...
	 */
		...
		function getCurrPurchase(){
		 alert("getCurrPurchase");
			...
			{
				document.getElementById('alertMsg').innerHTML = "";
				var pdfline="<iframe src='"+pdf_url_sale_rpt_doctor_wise_sale_summary+"?cmpnyId="+compid+"&storeId="+storeid+"&finYrId="+finyrid+"&doctorId="+doctorId+"&startDate="+strtdate+"&endDate="+enddate+"&rptType="+rpttype+"' style='width:100%; height:450px;' frameborder='0'></iframe>";
