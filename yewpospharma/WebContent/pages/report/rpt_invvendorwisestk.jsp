...
var pdf_url_sale_reg='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_REP_INV_VENDORWISE_STOCK)%>';
	...
	function getCurrSale(){
		...
		else
		{
			...
			var pdfline="<iframe src='"+pdf_url_sale_reg+"?cmpnyId="+compid+"&storeId="+storeid+"&finYrId="+finyrid+"&startDate="+strtdate+"&endDate="+enddate+"&distributorId="+distributorid+"' style='width:100%; height:450px;' frameborder='0'></iframe>";
