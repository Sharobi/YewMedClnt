...
<section class="wrapper">
	<div class="row">
		<div class="col-lg-12">
			<p><spring:message code="rptpurchasereg.jsp.title" text="H1 Register..." /></p>
			<div class="panel panel-default">
				...
				<div id="rpth1regdiv" style="height: 450px;width: 100%;"></div>
			</div>
		</div>
	</div>
</section>
...
// });
var pdf_url_purchase_reg='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_REP_PROC_H1REGIS)%>';
	...
	function getCurrPurchase(){
		...
		else
		{
			...
			document.getElementById('rpth1regdiv').innerHTML=pdfline;
		}
	}
