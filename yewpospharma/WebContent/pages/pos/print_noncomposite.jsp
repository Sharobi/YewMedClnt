		...
		<div style="margin: 0 auto; height: auto; width: 100%; float: center; font-family: verdana;">
       			...
       			<label style="width: 10%;font-weight: 600;"><b><spring:message code="reprintcash.jsp.billdetails" text="Bill Details" /></b>:</label>
					...
					<c:if test="${saleHeaderDTO.customerGstNo!=''}">
						<div id="placetreatment">
							<label style="width: 10%;">GSTIN:</label> <label>${saleHeaderDTO.customerGstNo}</label>
						</div>
					</c:if>
			...
			<div style="margin-bottom: 1px;">
				<table style="width: 100%;">
					<tr>
						<td style=""><spring:message code="reprintcash.jsp.totinvfigr" text="Total Invoice Value (In Figures)" />:</td><td><span id="totInvValue" style="text-align: left;"> <fmt:formatNumber value="${saleHeaderDTO.netAmount-saleHeaderDTO.adjAmount}" currencySymbol="" type="currency" groupingUsed="false" />
						</span></td>
