...
var pdf_url_sale_item='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_REP_INV_EXPDISTWISE)%>';
	...
	function getCurrExpDistWise(){
		...
		else
		{
			...
			var pdfline="<iframe src='"+pdf_url_sale_item+"?cmpnyId="+compid+"&storeId="+storeid+"&finYrId="+finyrid+"&distId="+seldistributor+"&itemId="+itemid+"&startDate="+strtdate+"&endDate="+enddate+"' style='width:100%; height:450px;' frameborder='0'></iframe>";
			console.log("repinv.expdistwise: "+pdfline);
