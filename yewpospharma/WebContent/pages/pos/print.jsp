...
<body>
	...
	<div id="printdiv" class="print hide">
		<div style="margin: 0 auto; height: auto; width: 100%; float: center; font-family: verdana;">
			...
			<p id="addcontId" style="text-align: center; margin: 0; padding: 0;">Chemist & Druggist, ${sessionScope.sesloggedinStore.address},${sessionScope.sesloggedinStore.phone}</p>
			<p id="dlcontId" style="text-align: center; margin: 0; padding: 0;">D.L.No.: ${sessionScope.sesloggedinStore.dlLicenceNo} ,State Membership No. : ${sessionScope.sesloggedinStore.stateLicenceNo}</p>
			...
			<div style="float: center; height: auto; width: 100%; margin-bottom: 5px;">
				<div id="billinginfo_div">
   			    ...
   			    <c:if test="${saleHeaderDTO.esiType!=''}">
					...
					<div>
						<label style="width: 10%;"><spring:message code="reprintcash.jsp.ptntname" text="Patient Name" />:</label> <label id="patientName_label">${saleHeaderDTO.customerName} <span id="genders">${saleHeaderDTO.gender}</span></label>
					</div>
					<div>
						<label style="width: 10%;"><spring:message code="reprintcash.jsp.ptntphn" text="Patient Ph No." />:</label> <label id="patientName_label">${saleHeaderDTO.customerPhone}</label>
					</div>
					<div>
				...
				<table id="billitemtable" style="text-align: center; border-collapse: collapse; width: 100%;">
					<thead style="border-bottom: 1px dashed;">
						<tr>
							...
							<th class="unit"><spring:message code="expiry.jsp.unit" text="Unit" /></th>
						...
						<th width="5%;"><spring:message code="purinvdet.jsp.lqty" text="L.Qty" /></th> --%>
							...
							<th>&nbsp;<spring:message code="purinvdet.jsp.total" text="Total" />&nbsp;
							</th>
							<th>&nbsp;<spring:message code="purinvdet.jsp.disc" text="Disc" />&nbsp;
							</th>
							<th>&nbsp;<spring:message code="reprintcash.jsp.taxableamt" text="Taxable Amt." />&nbsp;
							</th>
			...
			<div style="margin-bottom: 1px;">
				<table style="width: 100%;">
					<tr>
						...
						<td><spring:message code="reprintcash.jsp.totinvfigr" text="Total Invoice Value (In Figures)" />:</td><td><span id="totInvValue" style="text-align: left; font-weight: bold;"> <fmt:formatNumber value="${saleHeaderDTO.netAmount-saleHeaderDTO.adjAmount}" currencySymbol="" type="currency" groupingUsed="false" />
						</span></td>
