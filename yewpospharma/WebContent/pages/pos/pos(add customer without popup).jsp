			...
			<div class="tab-content" id="myTabContent">
				<div class="tab-pane fade active in" role="tabpanel" id="home" aria-labelledby="home-tab">
								...
								<table>
									<c:if test="${saleId==0}">
										...
										<tr>
											...
											<td style="padding: 0 1px;"><input class="form-control-trx" id="salecustph" type="text"><input type="hidden" id="salecustid" value="0"><input type="hidden" id="custCreditLimit" /></td>
											<td width="10%" style="padding: 0 1px;"><input class="form-control-trx" id="salecustname" type="text"></td>
											<td width="15%" style="padding: 0 1px;"><input class="form-control-trx" id="salecustaddr" type="text"></td>
											<td id="add_cust_td" class="hide">
												<button style="margin-right: 2px;" class="btn btn-primary" type="button" onclick="addEditCustomerDirect()">
											...
											<td width="25%" style="padding: 0 1px;"><input class="form-control-trx" id="saledocname" type="text"><input type="hidden" id="saledocid" value="0"></td>
									...
									<c:if test="${saleId!=0}">
										...
										<tr>
											...
											<td width="25%" style="padding: 0 1px;"><input class="form-control-trx" type="text" id="saledocname" value="${saleHeaderDTO.doctorName}"> <input type="hidden" id="saledocid" value="${saleHeaderDTO.doctorId}"></td>
											<td></td>
											<td id="add_doc_td" class="hide">
												<button class="btn btn-primary" type="button" onclick="openAddModal('doc')">
													<i class="fa fa-plus"></i>
							...
							<div class="panel-body-trx" id="header_div">
								<table>
									...
									<tr>
										...
										<td style="padding: 0 1px;"><input class="form-control-trx" type="text" id="item_pqty" onkeydown="numcheck(event)" value="0"> <input type="hidden" id="item_packunitid" value="0"></td>
										<td style="padding: 0 1px;"><input class="form-control-trx" type="text" id="item_lqty" onkeydown="numcheck(event)" value="0"><input type="hidden" id="item_looseunitid" value="0"> <input type="hidden" id="item_stockedqty" value="0"></td>
										<td style="padding: 0 1px;"><input class="form-control-trx" type="text" id="item_sale_rate" onkeydown="numcheck(event)"><input class="form-control-trx" type="hidden" id="item_purChase_rate"></td>
										<td style="padding: 0 1px;" id="item_dis_td"><input class="form-control-trx" type="text" id="item_dis" value="0.0000" onkeydown="numcheck(event)" ><input type="hidden" id="item_discamt" value="0"></td>
					...
					<td style="padding-right: 5px;"><input class="form-control-trx" id="remarks" type="text" value="${saleHeaderDTO.remarks}"></td> --%>
								...
								<td style="padding-right: 5px;" class=""><input class="form-control-trx" type="text" id="profitperc" value="" readonly="readonly"></td>  
								...
								<td colspan="2"><input class="form-control-trx" style="font-weight: bold; color: #000000; background-color: #ebccd1;" type="text" id="nettot" value="${saleHeaderDTO.netAmount}" tabindex="-1" readonly></td>
							</tr>
							<tr>
					...
					<table>
						...
						<c:if test="${saleRetId!=0}">
							...
							<tr>
								...
								<td style="padding: 0 1px;"><input class="form-control-trx" type="text" style="padding: 4px 1px;" id="retmemoDoc" value="SIM/" size="4" readonly>sdf</td>
								<td><input class="form-control-trx" type="text" style="padding: 4px 1px;" id="retmemoFinyr" value="${sessionScope.sesloggedinUser.finyrCode}" size="5"></td>
								<td style="padding: 0 1px;" width="2.5%"><input class="form-control-trx" type="text" style="padding: 4px 0px;" id="retmemoSlash" value="/" readonly></td>
		...
		<!-- <legend>Account</legend> -->
			<table    >
				...
				<tr>
					...
					<td>
					<input class="form-control-trx" style="font-weight: bold; color: #000000; background-color: #ebccd1;" type="text" id="totretamt_rsp" value="<fmt:formatNumber type="number" maxFractionDigits="2" minFractionDigits="2" groupingUsed="false" value="${saleReturnDTO.netAmount}" />" readonly>
					</td>
				...
				<tr>
					...
					<td colspan="6" style="padding: 3px 5px 0 0"><input class="form-control-trx" id="remarks_rsp" type="text" value="${saleReturnDTO.remarks}"></td>
					...
					<td colspan="5" style="padding-top: 4px; padding-right: 4px;"><c:if test="${saleReturnDTO.isPosted ==0}">
							<c:if test="${saleHeaderDTO.holdFlag ==0}">
...
<div class="modal fade" id="payModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog "  >
		<div class="modal-content">
					...
					<div class="form-horizontal">
						...
						<div id="carddiv" style="display: none;">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input class="form-control-trx" type="text" id="cardAmt"  onkeydown='numcheck(event)' value="${saleHeaderDTO.cardAmount}">
			...
			<c:if test="${saleHeaderDTO.holdFlag ==1}">
				<div class="col-sm-12" id="saleInvDivpaydet">
					<div class="form-horizontal">
						<div class="form-group">
							<label class="col-sm-4 col-sm-4 control-label" style="font-size: 16px; font-weight: bold; color: #d43f3a;"><spring:message code="pos.jsp.billamt" text="Bill Amount" /> :</label>
							<div class="col-sm-8">
						...
						<div class="form-group">
							<label class="col-sm-4 col-sm-4 control-label"><spring:message code="pos.jsp.tenderamt" text="Tender Amount" /> :</label>
							<div class="col-sm-8">
								<input class="form-control-trx" type="text" id="tenderamt" onkeydown='numcheck(event)'  value="${saleHeaderDTO.tenderAmount}" readonly="readonly">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 col-sm-4 control-label"><spring:message code="pos.jsp.refundamt" text="Refund Amount" /> :</label>
						...
						<div class="form-group">
							<label class="col-sm-4 col-sm-4 control-label"><spring:message code="pos.jsp.cashamt" text="Cash Amount" /> :</label>
							<div class="col-sm-8">
								<input class="form-control-trx" type="text" id="cashAmt" onkeydown='numcheck(event)'   value="${saleHeaderDTO.cashAmount}" readonly="readonly">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 col-sm-4 control-label"><spring:message code="pos.jsp.creditamt" text="Credit Amount" /> :</label>
						...
						<div id="carddiv" style="display: none;">
							<div class="form-group">
								<label class="col-sm-4 col-sm-4 control-label"><spring:message code="pos.jsp.cardamt" text="Card Amount" /> :</label>
								<div class="col-sm-8">
									<input class="form-control-trx" type="text" id="cardAmt"  onkeydown='numcheck(event)'  value="${saleHeaderDTO.cardAmount}" readonly="readonly">
			...
			<div class="modal-body">
				...
				<table>
					<tr>
						...
						<td style="padding: 0 1px;"  width="145px;" ><input class="form-control-trx" type="text" style="padding: 4px 1px;" id="retadjmemoDoc" value="SRM/" size="15" ></td>
