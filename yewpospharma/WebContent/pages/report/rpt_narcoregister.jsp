...
<section class="wrapper">
	<div class="row">
		<div class="col-lg-12">
			<p><spring:message code="rptpurchasereg.jsp.title" text="Narco Register..." /></p>
			<div class="panel panel-default">
				...
				<div id="rptnarcoregdiv" style="height: 450px;width: 100%;"></div>
			</div>
		</div>
	</div>
</section>
...
// });
var pdf_url_purchase_reg='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_REP_PROC_NARCOREGIS)%>';
	...
	function getCurrPurchase(){
		...
		else
		{
			...
			var pdfline="<iframe src='"+pdf_url_purchase_reg+"?cmpnyId="+compid+"&storeId="+storeid+"&finYrId="+finyrid+"&distributorId="+distid+"&startDate="+strtdate+"&endDate="+enddate+"' style='width:100%; height:450px;' frameborder='0'></iframe>";
			document.getElementById('rptnarcoregdiv').innerHTML=pdfline;
		}
	}
