...
var pdf_url_vendor_ledger='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_REP_VENDOR_LEDGERREPORT)%>';
	...
	function getVendorLedger(){
		...
		else
		{
			...
			var pdfline="<iframe src='"+pdf_url_vendor_ledger+"?cmpnyId="+compid+"&storeId="+storeid+"&finYrId="+finyrid+"&distId="+seldistributor+"&startDate="+strtdate+"&endDate="+enddate+"&status="+scheduleid+"' style='width:100%; height:450px;' frameborder='0'></iframe>";
