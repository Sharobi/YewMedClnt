...
var pdf_url_customer_ledger='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_REP_CUSTOMER_LEDGERREPORT)%>';
	...
	function getCurrSale(){
		...
		else
		{
			...
			var pdfline="<iframe src='"+pdf_url_customer_ledger+"?cmpnyId="+compid+"&storeId="+storeid+"&finYrId="+finyrid+"&custId="+custid+"&startDate="+strtdate+"&endDate="+enddate+"&status="+scheduleid+"' style='width:100%; height:450px;' frameborder='0'></iframe>";
