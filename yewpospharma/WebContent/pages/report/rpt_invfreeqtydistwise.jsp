...
var pdf_url_freeqty_distwise='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_REP_PROC_PURCHASE_FREEQTY)%>';
	...
	function getCurrExpDistWise(){
		...
		else
		{
			...
			var pdfline="<iframe src='"+pdf_url_freeqty_distwise+"?cmpnyId="+compid+"&storeId="+storeid+"&finYrId="+finyrid+"&distId="+seldistributor+"&startDate="+strtdate+"&endDate="+enddate+"' style='width:100%; height:450px;' frameborder='0'></iframe>";
