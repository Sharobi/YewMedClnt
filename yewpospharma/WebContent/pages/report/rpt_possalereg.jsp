				...
				<div class="panel-body">
					...
					<table>
						<tr align="center" style="font-weight: bold;">
								...
								<td><spring:message code="purinvreg.jsp.group" text="Groups" /></td>
								<td><spring:message code="purinvreg.jsp.schedule" text="Shedule" /></td>
								<td></td>
							</tr>
						<tr>
						...
						<fmt:parseDate value="${sessionScope.sesloggedinUser.endDate}" var="parsedEndDate" pattern="yyyy-MM-dd" />
								...
								<td style="padding: 0 1px;width: 0%;"><select class="form-control-trx" name="group" id="groupid" onchange="getSelcetedGroup()">
								...
								<td style="padding: 0 1px;width: 0%;"><select class="form-control-trx" name="schedule" id="scheduleid" onchange="getSelcetedSche()">
...
var pdf_url_sale_reg='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_REP_POS_SALEREGIS)%>';
	...
	function getCurrSale(){
		...
		else
		{
			...
			var pdfline="<iframe src='"+pdf_url_sale_reg+"?cmpnyId="+compid+"&storeId="+storeid+"&finYrId="+finyrid+"&schId="+scheduleid+"&grpId="+groupid+"&customerId="+custid+"&doctorId="+dctrid+"&itemId="+itemid+"&startDate="+strtdate+"&endDate="+enddate+"&rptType="+rpttype+"' style='width:100%; height:450px;' frameborder='0'></iframe>";
