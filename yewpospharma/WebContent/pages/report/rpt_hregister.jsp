...
<section class="wrapper">
	<div class="row">
		<div class="col-lg-12">
			<p><spring:message code="rptpurchasereg.jsp.title" text="H Register..." /></p>
			<div class="panel panel-default">
				...
				<div id="rpthregdiv" style="height: 450px;width: 100%;"></div>
			</div>
		</div>
	</div>
</section>
...
// });
var pdf_url_purchase_reg='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_REP_PROC_HREGIS)%>';
	...
	function getCurrPurchase(){
		...
		else
		{
			...
			document.getElementById('rpthregdiv').innerHTML=pdfline;
		}
	}
