...
var pdf_url_sale_item='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_REP_POS_SALESITEM)%>';
	...
	function getCurrSalesItems(){
		...
		else
		{
			...
			var pdfline="<iframe src='"+pdf_url_sale_item+"?cmpnyId="+compid+"&storeId="+storeid+"&finYrId="+finyrid+"&customerId="+custid+"&itemId="+itemid+"&contentId="+contentid+"&manufacturerId="+manufid+"&startDate="+strtdate+"&endDate="+enddate+"' style='width:100%; height:450px;' frameborder='0'></iframe>";
