				...
				<div class="panel-body">
					...
					<table>
						<tr align="center" style="font-weight: bold;">
								...
								<td width="30%"><spring:message code="item.jsp.name" text="Item Name" /></td>
								<td></td>
							</tr>
						<tr>
...
var pdf_url_purchase_itemwise='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_REP_PROC_PURCHASERETURNITEM)%>';
	...
	function getCurrPurchaseItems(){
		...
		else
		{
			...
			var pdfline="<iframe src='"+pdf_url_purchase_itemwise+"?cmpnyId="+compid+"&storeId="+storeid+"&finYrId="+finyrid+"&distributorId="+distid+"&itemId="+itemid+"&contentId="+contentid+"&manufacturerId="+manufid+"&startDate="+strtdate+"&endDate="+enddate+"' style='width:100%; height:450px;' frameborder='0'></iframe>";
