		...
		<div class="modal-content">
			...
			<div class="modal-body" id="itemMasterModalBody">
				<div class="col-md-6 col-sm-12">
					<div class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" value="" id="barcode" class="form-control-trx" name="sku" placeholder="Barcode">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group hide">
							...
							<div class="col-sm-8">
								<div class="input-group">
									...
									<div class="input-group-btn noneditablediv">
						...
						<div class="form-group">
							<label class="col-sm-4 col-sm-4 control-label" id="purchasetax_label">Purchase Tax <span class="required_star">*</span></label>
							<div class="col-sm-8">
								<div class="input-group">
									<input type="hidden" id="purchaseTaxId" value="" class="form-control-trx" name="purchaseTaxId"><input type="hidden" id="purchaseTaxPerc" value=""
														class="form-control-trx" name="purchaseTaxPercentage"><input type="text" id="purchaseTax" value="" class="form-control-trx" name="purchaseTax" placeholder="Purchase Tax(Please type atleast 2 characters)">
									<div class="input-group-btn">
						...
						<div class="form-group">
							<label class="col-sm-4 col-sm-4 control-label" id="saletax_label">Sale Tax <span class="required_star">*</span>
							</label>
							<div class="col-sm-8">
								<div class="input-group">
									<input type="hidden" id="saleTaxId" value="" class="form-control-trx" name="saleTaxId"> <input type="hidden" id="saleTaxPerc" value=""
														class="form-control-trx" name="saleTaxPercentage"><input type="text" id="saleTax" value="" class="form-control-trx" name="saleTax" placeholder="Sale Tax(Please type atleast 2 characters)">
									<div class="input-group-btn">
										<button class="btn btn-primary btn-sm" type="button" style="padding: 7px;" onclick="openTaxMod('S')">
											<i class="fa fa-plus"></i>
										</button>
									</div>
								</div>
				...
				<div class="col-md-6 col-sm-12">
					<div class="form-horizontal">
						<div class="form-group hide">
							<label class="col-sm-4 col-sm-4 control-label" id="code_label"><spring:message code="itemmstr.jsp.code" text="Code" /> <span class="required_star">*</span></label>
							<div class="col-sm-8">
							...
							<div class="col-sm-8">
								<div class="input-group">
									...
									<div class="input-group-btn">
										...
										<button class="btn btn-primary btn-sm noneditablediv" type="button" style="padding: 7px;" onclick="openContentMod()">
											<i class="fa fa-plus"></i>
										</button>
									</div>
								</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="checkbox" id="isLooseSale" name="isLooseSale" style="zoom: 1.5; vertical-align: middle; margin: 0px;" onchange="lseSaleChkBox();"><input type="hidden" id="lseSaleStat" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="number" id="itemMarkup" value="0" class="form-control-trx" name="markup" placeholder="<spring:message code="itemmstr.jsp.markupperc" text="Markup (%)" />">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" id="itemdiscount"  onkeydown="numcheck(event)" value="0.0" class="form-control-trx" name="discount" placeholder="Discount%">
							</div>
						</div>
					</div>
				</div>
